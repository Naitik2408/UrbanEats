...
/**
 * Reusable Button component following UI/UX best practices.
 * 
 * Features:
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      primary: 'bg-red-600 text-white hover:bg-red-700 hover:shadow-md focus:ring-red-500',
      secondary: 'bg-yellow-600 text-white hover:bg-yellow-700 hover:shadow-md focus:ring-yellow-500',
      outline: 'border-2 border-red-600 text-red-600 hover:bg-red-50 focus:ring-red-500',
      ghost: 'text-gray-700 hover:bg-gray-100 focus:ring-gray-500',
      danger: 'bg-red-700 text-white hover:bg-red-800 hover:shadow-md focus:ring-red-600',
    };
